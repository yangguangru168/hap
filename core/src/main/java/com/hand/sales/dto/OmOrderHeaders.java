...
public class OmOrderHeaders extends BaseDTO {
    ...
    @Children
    @Transient
    private List<OmOrderLines> linesList;
    ...
    public List<OmOrderLines> getLinesList() {
        return linesList;
    }

    public void setLinesList(List<OmOrderLines> linesList) {
        this.linesList = linesList;
    }

    public static String getFieldHeaderId() {
        return FIELD_HEADER_ID;
    }
