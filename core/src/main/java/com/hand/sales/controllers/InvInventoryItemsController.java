...
import java.util.List;
    ...
    private IInvInventoryItemsService service;
        ...
        @ResponseBody
        public ResponseData queryItem(InvInventoryItems dto, @RequestParam(defaultValue = DEFAULT_PAGE) int page,
                                  @RequestParam(defaultValue = DEFAULT_PAGE_SIZE) int pageSize, HttpServletRequest request) {
            IRequest requestContext = createRequestContext(request);
            return new ResponseData(service.myBranchLinSelect(requestContext,dto,page,pageSize));
        }
*/
    @RequestMapping(value = "/hap/inv/inventory/items/query")
    @ResponseBody
